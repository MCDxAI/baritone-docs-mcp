RelativeGoalYLevel (baritone 1.2.15 API)

baritone.api.command.datatypes

## Enum RelativeGoalYLevel

- java.lang.Object
  - java.lang.Enum< [RelativeGoalYLevel](../../../../baritone/api/command/datatypes/RelativeGoalYLevel.html "enum in baritone.api.command.datatypes") >
    - baritone.api.command.datatypes.RelativeGoalYLevel

- All Implemented Interfaces:[IDatatype](../../../../baritone/api/command/datatypes/IDatatype.html "interface in baritone.api.command.datatypes"), [IDatatypePost](../../../../baritone/api/command/datatypes/IDatatypePost.html "interface in baritone.api.command.datatypes") < [GoalYLevel](../../../../baritone/api/pathing/goals/GoalYLevel.html "class in baritone.api.pathing.goals"), [BetterBlockPos](../../../../baritone/api/utils/BetterBlockPos.html "class in baritone.api.utils") >, java.io.Serializable, java.lang.Comparable< [RelativeGoalYLevel](../../../../baritone/api/command/datatypes/RelativeGoalYLevel.html "enum in baritone.api.command.datatypes") >
...
extends java.lang.Enum<RelativeGoalYLevel>
...
All Methods[Static Methods](javascript:show(1);)[Instance Methods](javascript:show(2);)[Concrete Methods](javascript:show(8);)Modifier and TypeMethod and Description`GoalYLevel``apply(IDatatypeContext ctx,
...
`static RelativeGoalYLevel``valueOf(java.lang.String name)`

Returns the enum constant of this type with the specified name.

`static RelativeGoalYLevel[]``values()`
...
- ### Method Detail
  ...
  - #### values
    ...
    ```
    for (RelativeGoalYLevel c : RelativeGoalYLevel.values())
  ...
  - #### apply
    ...
    ```
    public GoalYLevel apply(IDatatypeContext ctx,
                            BetterBlockPos origin)
    ...
    Specified by:`apply` in interface `IDatatypePost<GoalYLevel,BetterBlockPos>`Parameters:`ctx` \- The datatype context`origin` \- The transformable valueReturns:The transformed valueThrows:`CommandException`
