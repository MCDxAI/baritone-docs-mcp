RelativeBlockPos (baritone 1.2.15 API)
...
- java.lang.Object
  - java.lang.Enum< [RelativeBlockPos](../../../../baritone/api/command/datatypes/RelativeBlockPos.html "enum in baritone.api.command.datatypes") >
    - baritone.api.command.datatypes.RelativeBlockPos

- All Implemented Interfaces:[IDatatype](../../../../baritone/api/command/datatypes/IDatatype.html "interface in baritone.api.command.datatypes"), [IDatatypePost](../../../../baritone/api/command/datatypes/IDatatypePost.html "interface in baritone.api.command.datatypes") < [BetterBlockPos](../../../../baritone/api/utils/BetterBlockPos.html "class in baritone.api.utils"), [BetterBlockPos](../../../../baritone/api/utils/BetterBlockPos.html "class in baritone.api.utils") >, java.io.Serializable, java.lang.Comparable< [RelativeBlockPos](../../../../baritone/api/command/datatypes/RelativeBlockPos.html "enum in baritone.api.command.datatypes") >
...
extends java.lang.Enum<RelativeBlockPos>
...
All Methods[Static Methods](javascript:show(1);)[Instance Methods](javascript:show(2);)[Concrete Methods](javascript:show(8);)Modifier and TypeMethod and Description`BetterBlockPos``apply(IDatatypeContext ctx,
...
`static RelativeBlockPos``valueOf(java.lang.String name)`

Returns the enum constant of this type with the specified name.

`static RelativeBlockPos[]``values()`
...
- ### Enum Constant Detail
  ...
  - #### INSTANCE
    ...
    ```
    public static final RelativeBlockPos INSTANCE
    ```
...
- ### Method Detail
  ...
  - #### values
    ...
    ```
    public static RelativeBlockPos[] values()
    ```
    ...
    ```
    for (RelativeBlockPos c : RelativeBlockPos.values())
  ...
  - #### valueOf
    ...
    ```
    public static RelativeBlockPos valueOf(java.lang.String name)
    ```
  ...
  - #### apply
    ...
    ```
    public BetterBlockPos apply(IDatatypeContext ctx,
                                BetterBlockPos origin)
    ...
    Specified by:`apply` in interface `IDatatypePost<BetterBlockPos,BetterBlockPos>`Parameters:`ctx` \- The datatype context`origin` \- The transformable valueReturns:The transformed valueThrows:`CommandException`
