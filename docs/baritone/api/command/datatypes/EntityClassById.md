EntityClassById (baritone 1.2.15 API)

baritone.api.command.datatypes

## Enum EntityClassById

- java.lang.Object
  - java.lang.Enum< [EntityClassById](../../../../baritone/api/command/datatypes/EntityClassById.html "enum in baritone.api.command.datatypes") >
    - baritone.api.command.datatypes.EntityClassById

- All Implemented Interfaces:[IDatatype](../../../../baritone/api/command/datatypes/IDatatype.html "interface in baritone.api.command.datatypes"), [IDatatypeFor](../../../../baritone/api/command/datatypes/IDatatypeFor.html "interface in baritone.api.command.datatypes") <java.lang.Class<? extends net.minecraft.entity.Entity>>, java.io.Serializable, java.lang.Comparable< [EntityClassById](../../../../baritone/api/command/datatypes/EntityClassById.html "enum in baritone.api.command.datatypes") >
...
extends java.lang.Enum<EntityClassById>
implements IDatatypeFor<java.lang.Class<? extends net.minecraft.entity.Entity>>
```
...
All Methods[Static Methods](javascript:show(1);)[Instance Methods](javascript:show(2);)[Concrete Methods](javascript:show(8);)Modifier and TypeMethod and Description`java.lang.Class<? extends net.minecraft.entity.Entity>``get(IDatatypeContext ctx)`
...
`static EntityClassById``valueOf(java.lang.String name)`

Returns the enum constant of this type with the specified name.

`static EntityClassById[]``values()`
...
- ### Enum Constant Detail
  ...
  - #### INSTANCE
    ...
    ```
    public static final EntityClassById INSTANCE
    ```
...
- ### Method Detail
  ...
  - #### values
    ...
    ```
    public static EntityClassById[] values()
    ```
    ...
    ```
    for (EntityClassById c : EntityClassById.values())
  ...
  - #### valueOf
    ...
    ```
    public static EntityClassById valueOf(java.lang.String name)
    ```
  ...
  - #### get
    ...
    ```
    public java.lang.Class<? extends net.minecraft.entity.Entity> get(IDatatypeContext ctx)
    ...
    Specified by:`get` in interface `IDatatypeFor<java.lang.Class<? extends net.minecraft.entity.Entity>>`Parameters:`ctx` \- The contextReturns:The parsed data-typeThrows:`CommandException` \- If there was an issue parsing using another type or arguments could not be polled.See Also:[`IDatatypeContext`](../../../../baritone/api/command/datatypes/IDatatypeContext.html "interface in baritone.api.command.datatypes")
