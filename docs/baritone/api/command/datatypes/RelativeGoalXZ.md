RelativeGoalXZ (baritone 1.2.15 API)
...
- java.lang.Object
  - java.lang.Enum< [RelativeGoalXZ](../../../../baritone/api/command/datatypes/RelativeGoalXZ.html "enum in baritone.api.command.datatypes") >
    - baritone.api.command.datatypes.RelativeGoalXZ

- All Implemented Interfaces:[IDatatype](../../../../baritone/api/command/datatypes/IDatatype.html "interface in baritone.api.command.datatypes"), [IDatatypePost](../../../../baritone/api/command/datatypes/IDatatypePost.html "interface in baritone.api.command.datatypes") < [GoalXZ](../../../../baritone/api/pathing/goals/GoalXZ.html "class in baritone.api.pathing.goals"), [BetterBlockPos](../../../../baritone/api/utils/BetterBlockPos.html "class in baritone.api.utils") >, java.io.Serializable, java.lang.Comparable< [RelativeGoalXZ](../../../../baritone/api/command/datatypes/RelativeGoalXZ.html "enum in baritone.api.command.datatypes") >
...
extends java.lang.Enum<RelativeGoalXZ>
...
All Methods[Static Methods](javascript:show(1);)[Instance Methods](javascript:show(2);)[Concrete Methods](javascript:show(8);)Modifier and TypeMethod and Description`GoalXZ``apply(IDatatypeContext ctx,
...
`static RelativeGoalXZ``valueOf(java.lang.String name)`

Returns the enum constant of this type with the specified name.

`static RelativeGoalXZ[]``values()`
...
- ### Enum Constant Detail
  ...
  - #### INSTANCE
    ...
    ```
    public static final RelativeGoalXZ INSTANCE
    ```
...
- ### Method Detail
  ...
  - #### values
    ...
    ```
    public static RelativeGoalXZ[] values()
    ```
    ...
    ```
    for (RelativeGoalXZ c : RelativeGoalXZ.values())
  ...
  - #### valueOf
    ...
    ```
    public static RelativeGoalXZ valueOf(java.lang.String name)
    ```
  ...
  - #### apply
    ...
    ```
    public GoalXZ apply(IDatatypeContext ctx,
                        BetterBlockPos origin)
    ...
    Specified by:`apply` in interface `IDatatypePost<GoalXZ,BetterBlockPos>`Parameters:`ctx` \- The datatype context`origin` \- The transformable valueReturns:The transformed valueThrows:`CommandException`
