MaskSchematic (baritone 1.2.15 API)
...
- All Implemented Interfaces:[ISchematic](../../../baritone/api/schematic/ISchematic.html "interface in baritone.api.schematic")Direct Known Subclasses:[ReplaceSchematic](../../../baritone/api/schematic/ReplaceSchematic.html "class in baritone.api.schematic"), [ShellSchematic](../../../baritone/api/schematic/ShellSchematic.html "class in baritone.api.schematic"), [WallsSchematic](../../../baritone/api/schematic/WallsSchematic.html "class in baritone.api.schematic")
...
ConstructorsConstructor and Description`MaskSchematic(ISchematic schematic)`

- ### Method Summary

All Methods[Instance Methods](javascript:show(2);)[Abstract Methods](javascript:show(4);)[Concrete Methods](javascript:show(8);)Modifier and TypeMethod and Description`net.minecraft.block.state.IBlockState``desiredState(int x,
              int y,
              int z,
...
`protected abstract boolean``partOfMask(int x,
            int y,
            int z,
            net.minecraft.block.state.IBlockState currentState)`
